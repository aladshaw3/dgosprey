 ...
 *	\details This file is responsible for calculating the adsorption perturbation based on linear driving force kinetics
...
#ifndef MAGPIE_MaterialLDF_Perturbation_H
#define MAGPIE_MaterialLDF_Perturbation_H

/// MAGPIE_MaterialLDF_Perturbation class object forward declaration
class MAGPIE_MaterialLDF_Perturbation;
...
/// MAGPIE_MaterialLDF_Perturbation class inherits from AuxKernel
...
class MAGPIE_MaterialLDF_Perturbation : public Aux_LDF
{
public:
	/// Standard MOOSE public constructor
	MAGPIE_MaterialLDF_Perturbation(const InputParameters & parameters);
