/*!
 *  \file MAGPIE_ConstLDF_Perturbation.h
 *	\brief Auxillary kernel to calculate adsorption perturbation based on LDF kinetics with constant coefficients
...
/// MAGPIE_ConstLDF_Perturbation class object forward declaration
class MAGPIE_ConstLDF_Perturbation;
...
class MAGPIE_ConstLDF_Perturbation : public Aux_LDF
{
public:
	/// Standard MOOSE public constructor
	MAGPIE_ConstLDF_Perturbation(const InputParameters & parameters);
