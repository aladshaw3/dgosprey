...
_coupled_var_i(coupled("main_coupled"))
{
	...
	{
		_coupled_vars[i] = coupled("coupled_list",i); //may only be useful for compute Jacobian Off Diagonal (see ~/projects/truck/moose/modules/chemical_reactions/ .../ CoupledConvectionReactionSub.C)
